...
2. **Commits must be atomic.** One logical change per commit. Imperative mood, <70 chars. Merge commits are exempt from the length limit — their subject line is generated by Git/GitHub, not authored.
