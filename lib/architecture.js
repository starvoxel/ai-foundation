 ...
 * (`#foo`). Fenced code blocks are skipped — they hold illustrative example
 * syntax, not real links, same convention as `validateCitations` in
...
export function findBrokenLinks(architectureDir) {
  ...
  for (const relPath of collectArchitectureFiles(architectureDir)) {
