 ...
 * @property {(agent: object) => string|null} [detectSharedResource] - Given a parsed agent, returns the name of a harness-level shared resource it requires (e.g. "block-command"), or null
 ...
 * @returns {object} Adapter with installAgents, installSteering, installSkills, installServers, installSharedResources
 */
