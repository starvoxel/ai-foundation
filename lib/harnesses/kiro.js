 ...
 * @param {import('./base.js').AgentDef} agent - Parsed agent YAML object
 ...
 * @param {import('./base.js').ServerDef} serverDef - Parsed server YAML definition
 ...
 *
 * @param {string} name - Server folder name
 * @param {import('./base.js').ServerDef} serverDef - Parsed server YAML
