...
| Artifact file naming                       | Type suffix in the filename: `.feature.md`, `.plan.md`, `.decision.md`, `.test-results.md` — the suffix alone identifies what a file is without opening it.                                                                |
