...
export const TOOLS = {
  ...
  TASK: 'task',
  // Invoke an installed skill by name. Granted universally — without it, a
  // harness that gates skill access behind an explicit tool allowlist (see
  // Claude Code below) leaves the agent with no skill awareness at all, not
  // just blocked invocation (confirmed empirically, not just documented).
  SKILL: 'skill',
};
