...
| AI-component/declarative-system                           | `AIC`  | AI-Engineer _(existing precedent, AIF-PROC-001)_                                                        | Agent, skill, steering, or schema impact                           | Yes — scoped to AI-Engineer + adjacent authoring skills                                                     |
| Quality-gate/review-process                               | `QA`   | Principal-Engineer                                                                                      | Review-criteria and severity-gate changes                          | No — implemented effect lives in the review skill's template                                                |
