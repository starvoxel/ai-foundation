/**
 * Unit tests for lib/file-utils.js's pure functions (parseFrontmatter, hashContent).
 */
...
describe('unit: file-utils/parseFrontmatter', () => {
...
describe('unit: file-utils/hashContent', () => {
