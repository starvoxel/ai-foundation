/**
 * .aiconfig.json resolver — the I/O layer that reads a project's
 * .aiconfig.json off disk and hands it to lib/aiconfig-resolve.js's pure
 * merge logic. This file is the one-stop entry point for callers; the
 * actual "config value, else default" resolution has no file access and
 * lives in lib/aiconfig-resolve.js so it can be unit tested without
 * touching disk.
 *
...
import { resolveConfigValue } from './aiconfig-resolve.js';

export { resolveConfigValue };
