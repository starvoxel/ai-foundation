...
This is still the largest heterogeneous group in §5's "Core libraries" row — 7
files across 4 unrelated responsibilities, and the one most likely to gain a new
...
uses `project-init.js`. `bin/ai-git.js` is the sole caller of `ai-git.js`.
