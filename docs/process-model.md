...
`skill/review-severity`); only where it lands changes — as PR review comments/threads
instead of session-only output — and when it's produced changes too, since the PR now
