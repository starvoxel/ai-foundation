 ...
 * @returns {{ bundles: object, servers: object, hooks: object }}
 */
 ...
 * @param {{ bundles: object, servers: object, hooks: object }} data
 * @returns {string}
 */
 ...
 * @param {'bundles'|'servers'|'hooks'} section
 * @param {string} key
 * @returns {{ manifest: { bundles: object, servers: object, hooks: object }, removed: boolean }}
 */
